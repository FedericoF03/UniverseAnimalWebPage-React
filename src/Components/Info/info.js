    ...
    return(
        <div className="container__general--85vh">
            <div>
                ...
                <p>Asociacion civil universo animal 
                    tiene su domicilio legal en la 
                    jurisdiccion de la Provincia de 
                    Buenos Aires, se constituye a perpetuidad, 
                    pudiendo establecer fililales en 
                    todo el territorio nacion y/o extranjero.
                </p>
            ...
            <div>
                ...
                <ul className='box__objetivos'>
                    <div className='box__objetivos--tema-1'>
                        texto
                    </div>
